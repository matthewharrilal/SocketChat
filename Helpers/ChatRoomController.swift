...
class ChatRoomController: NSObject {
    ...
    func setUpNetworkCommunication() {
        ...
        CFStreamCreatePairWithSocketToHost(kCFAllocatorDefault, "52.91.109.76", "1234", readStream, writeStream)
        ...
        self.inputStream = readStream?.takeRetainedValue() // This gives us access to read data from the input stream
        self.outputStream = writeStream?.takeRetainedValue() // Gives us access to write data to the output stream
